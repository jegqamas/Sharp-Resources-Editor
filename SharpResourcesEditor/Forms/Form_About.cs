...
namespace SharpResourcesEditor
{
    partial class Form_About : Form
    {
        public Form_About()
        {
            ...
            this.labelCompanyName.Text = "Email: alaahadidfreeware@gmail.com\nWebsite/Repository: https://github.com/alaahadid/Sharp-Resources-Editor";
            /*
...
"\nYou should have received a copy of the GNU General Public License along with this program.  If not, see <http://www.gnu.org/licenses/>.";
            this.textBoxDescription.Lines = desc.Split(new char[] { '\n' });*/
        }
